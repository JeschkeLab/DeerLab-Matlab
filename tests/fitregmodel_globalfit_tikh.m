...
% Test global fit using Tikhonov regularization
...
Pglobal = fitregmodel(Ss,Ks,r,'tikh',regparam,'Solver','fnnls');
Plocal1 = fitregmodel(S1,K1,r,'tikh',regparam,'Solver','fnnls');
Plocal2 = fitregmodel(S2,K2,r,'tikh',regparam,'Solver','fnnls');
Plocal3 = fitregmodel(S3,K3,r,'tikh',regparam,'Solver','fnnls');
