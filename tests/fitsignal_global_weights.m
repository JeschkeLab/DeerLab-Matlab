...
% Check that fitsignal() correctly uses supplied global weights
...
V1 = dipolarsignal(t1,r,P,'noiselevel',0.01);
V2 = dipolarsignal(t2,r,P,'noiselevel',0.01);

[Vfit,Pfit] = fitsignal({V1,V2},{t1,t2},r,'P','none','none','GlobalWeights',[1 1]);
