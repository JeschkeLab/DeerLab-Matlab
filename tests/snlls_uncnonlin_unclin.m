...
% Test snlls to solve a nonlinear unconstrained  + linear unconstrained
...
% nlpar = [r1 w1 r2 w2];
nlpar0 = [3.2 0.1 4.2 0.3];

% Separable LSQ fit
[nonlinfit,linfit] = snlls(V,@(p)Kmodel(p,t,r),nlpar0);
